...
const DotGrid: React.FC<DotGridProps> = ({
  ...
  const currentBaseColor = theme === "light" ? lightBaseColor : baseColor;
  const currentActiveColor = theme === "light" ? lightActiveColor : activeColor;

  const baseRgb = useMemo(() => hexToRgb(currentBaseColor), [currentBaseColor]);
  const activeRgb = useMemo(
    () => hexToRgb(currentActiveColor),
    [currentActiveColor]
  );
