    ...
    <div className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative z-10 w-full max-w-6xl px-4 text-center">
          <p className="inline-block text-sm md:text-base tracking-[0.3em] uppercase mb-8 text-gray-800 dark:text-gray-300 bg-[#ffffff] dark:bg-[#0a0a0a] px-3 py-1 rounded">
            CODE. CREATE. INNOVATE.
          </p>

          <BlurTitle />

          <p className="inline-block text-lg md:text-xl mt-8 text-gray-800 dark:text-gray-200 bg-[#ffffff] dark:bg-[#0a0a0a] px-3 py-1 rounded">
